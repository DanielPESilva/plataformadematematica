...
async function seedDatabase() {
  try {
    ...
    const modulos = await prisma.modulo.createMany({
      data: [
        { turma_id: 1, titulo: 'Módulo 1', descricao: 'Descrição do Módulo 1 do 1º Ano' },
        { turma_id: 1, titulo: 'Módulo 2', descricao: 'Descrição do Módulo 2 do 1º Ano' },
        { turma_id: 2, titulo: 'Módulo 1', descricao: 'Descrição do Módulo 1 do 2º Ano' },
        { turma_id: 2, titulo: 'Módulo 2', descricao: 'Descrição do Módulo 2 do 2º Ano' },
        { turma_id: 3, titulo: 'Módulo 1', descricao: 'Descrição do Módulo 1 do 3º Ano' },
        { turma_id: 3, titulo: 'Módulo 2', descricao: 'Descrição do Módulo 2 do 3º Ano' },
      ],
    });
